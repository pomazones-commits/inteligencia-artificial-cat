...
> Motiu: l'auditoria del 08.08.2026 sobre les 428 notícies publicades entre el 12.07 i el 06.08 va trobar que el **43,9%** del feed era d'àmbit econòmic-empresarial (negoci, mercats i inversió, infraestructura com a negoci) i només el **4,7%** era de ciència o de salut. **12 dels 26 dies no van publicar ni una sola peça científica**, amb ratxes de fins a 5 dies seguits. Només 3 peces de 428 venien de premsa científica, davant de 114 de premsa econòmica. La causa no era el model sinó les instruccions: el criteri **b** era l'única cerca temàtica obligatòria del sistema i era econòmica. Aquest criteri **d** hi posa el contrapès. **Revisat el mateix 08.08.2026**: la quota inicial (2 al dia) es va considerar massa curta i es va apujar a **2 per lot, 8 al dia**, amb un ordre de prioritat explícit de les places perquè no ofegui l'actualitat.

- **CADA LOT porta 2 notícies de ciència de les seves 5.** Són **8 al dia** sobre 20 (40%). No és una quota que es compensi entre lots: **cada lot n'ha de portar dues**. Si un dia un lot només n'ha pogut portar una de bona, el lot següent **n'ha de portar tres** per recuperar-la. Comprova què s'ha publicat avui llegint `public/news.js` abans de tancar el lot.
- ⚠️ **Ordre de prioritat de les 5 places del lot** (des del 08.08.2026, perquè la quota no ofegui l'actualitat): **(1)** la notícia global més important del dia en IA — aquesta no pot faltar mai, encara que obligui a deixar la segona catalana per al lot següent; **(2)** les 2 peces de ciència; **(3)** la resta d'actualitat global; **(4)** les catalanes, **màxim 2 per lot** (criteri **c**) i sovint 1 de sola quan el lot ja porta les dues de ciència. Si les places no donen, el que cedeix és la segona catalana, **mai** la notícia gran del dia ni la segona de ciència.
- **Què compta com a ciència** (ha de complir-se com a mínim un):
  - recerca publicada o en preprint: articles revisats, *Nature*, *Science*, *Nature Medicine*, *PNAS*, *The Lancet*, arXiv, actes de congressos (NeurIPS, ICML, ACL…);
  - **IA aplicada a una disciplina científica**: biologia, medicina, química, materials, física, matemàtiques, clima, energia, astronomia, neurociència, arqueologia, lingüística;
  ...
  - **ciència feta aquí**: BSC-MareNostrum, IIIA-CSIC, ICFO, IRB Barcelona, CRG, ICREA, Eurecat, i2CAT, VHIR, IDIBAPS, universitats catalanes i espanyoles.
- **Què NO compta** (error real detectat a l'auditoria): una notícia **corporativa amb decorat científic** no és ciència. No compten «OpenAI regala accés a 100.000 científics», «un medallista Fields fitxa per una empresa d'IA», «DeepMind desmantella l'equip d'AlphaFold» ni «tal centre rep X milions europeus». El criteri és senzill: **si en treus els diners i el nom de l'empresa i no queda cap resultat científic, no compta**.
...
- **Categoria.** Fes servir `"category": "CIÈNCIA"` (amb accent) quan la peça sigui de recerca, i `"SALUT"` quan sigui clínica. ⚠️ Escriu-la **sempre igual**: a l'hemeroteca hi conviuen `CIÈNCIA` i `CIENCIA` i el desplegable del cercador les ha d'unir a mà.
- **On buscar-la, cada dia.** El material hi és sempre; el que fallava eren les instruccions, no el subministrament. Fonts de partida: el llistat diari d'**arXiv** (`cs.AI`, `cs.LG`, `cs.CL`, `q-bio`), **Nature** i **Nature Machine Intelligence**, **Science**, **Nature Medicine**, **The Lancet Digital Health**, **PNAS**, la secció d'IA de **ScienceDaily**, **Quanta Magazine**, els blogs de recerca dels laboratoris (DeepMind, Anthropic, OpenAI, Meta AI, Allen Institute, EPFL, MIT News) i les notes dels centres d'aquí (BSC, IIIA-CSIC, ICFO, IRB, CRG, ICREA, UPC, UPF, UB, UAB). Amb 8 places al dia has de baixar més enllà del titular del dia: **una peça de recerca sòlida i ben explicada val més que la cinquena notícia d'un acord milionari.**
- **Si un dia no hi ha ciència de debò, no la inventis ni inflis un anunci d'empresa.** Val més publicar-ne una de menys i deixar-ho documentat que forçar-ne una de dolenta; la recuperes al lot següent. Però que això sigui l'excepció rara, no la norma: **cada setmana ha de tenir com a mínim 50 peces científiques** sobre les 140 del període.
