...
> Motiu: l'auditoria del 08.08.2026 sobre les 428 notícies publicades entre el 12.07 i el 06.08 va trobar que el **43,9%** del feed era d'àmbit econòmic-empresarial (negoci, mercats i inversió, infraestructura com a negoci) i només el **4,7%** era de ciència o de salut. **12 dels 26 dies no van publicar ni una sola peça científica**, amb ratxes de fins a 5 dies seguits. Només 3 peces de 428 venien de premsa científica, davant de 114 de premsa econòmica. La causa no era el model sinó les instruccions: el criteri **b** era l'única cerca temàtica obligatòria del sistema i era econòmica. Aquest criteri **d** hi posa el contrapès.

- **Cada dia (els 4 lots junts, 20 notícies) hi ha d'haver com a MÍNIM 2 notícies de ciència.** En la pràctica: **el lot de les 06:05 i el de les 14:05 porten cadascun almenys 1 peça científica** entre les seves 5. Si un d'aquests dos lots no n'ha pogut portar cap, el lot següent del dia **n'ha de portar dues** per recuperar la quota. Comprova-ho llegint `public/news.js` abans de tancar el lot.
...
- **Si un dia no hi ha ciència de debò, no la inventis ni inflis un anunci d'empresa.** Val més publicar-ne una de sola i deixar-ho documentat que forçar-ne dues de dolentes. Però que això sigui l'excepció, no la norma: cada setmana ha de tenir com a mínim **10 peces científiques** sobre les 140 del període.
