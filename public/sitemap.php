...
$pages = ['redaccio.html', 'avis-legal.html', 'eines.html', 'analisi.html', 'arxiu-analisis.html', 'tribuna.html', 'arxiu-tribuna.html', 'estudi.html', 'arxiu-estudis.html', 'quadern.html', 'reflexio.html', 'arxiu-reflexions.html', 'dossiers.html', 'arxiu.html'];
...
// Pàgines de secció: es reconstrueixen amb cada edició, per tant comparteixen
// la data de l'última edició publicada.
$pages = ['redaccio.html', 'avis-legal.html', 'eines.html', 'analisi.html', 'tribuna.html', 'arxiu-tribuna.html', 'estudi.html', 'arxiu-estudis.html', 'quadern.html', 'reflexio.html', 'arxiu-reflexions.html', 'dossiers.html', 'arxiu.html'];
foreach ($pages as $page) {
    $urls[] = ['loc' => $base . '/' . $page, 'lastmod' => $siteIso];
}
